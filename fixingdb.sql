...
(1,'Do Anh Khoa','dokhoa@uni.edu.vn','123456789','dokhoa','123456',_binary '','admin',NULL),
(2,'Duong Huu Thanh','duongthanh@uni.edu.vn','987654321','duongthanh','123456',_binary '','giangvien',NULL),
(3,'Nguyen Chanh Khoi','nguyenkhoi@uni.edu.vn','654321789','nguyenkhoi','123456',_binary '','sinhvien','https://res.cloudinary.com/dbqaequqv/image/upload/v1718265744/student_ninfvs.png'),(4,'Nguyen Van A','nguyena@uni.edu.vn','456789123','nguyena','123456',_binary '','sinhvien','https://res.cloudinary.com/dbqaequqv/image/upload/v1718265744/student_ninfvs.png'),
(5,'Ho Anh B','hob@uni.edu.vn','789123456','hob','123456',_binary '','sinhvien','https://res.cloudinary.com/dbqaequqv/image/upload/v1718265744/student_ninfvs.png'),(6,'Truong Van C','truongc@uni.edu.vn','128478798','truongc','123456',_binary '','giangvien',NULL),(7,'Nguyễn Văn A','nguyena@example.com','123456780','nguyena','123456',_binary '','giangvien',NULL),(8,'Lê Thị B','leb@example.com','123456781','leb','123456',_binary '','giangvien',NULL),(9,'Phạm Văn D','phamd@example.com','123456782','phamd','123456',_binary '','giangvien',NULL),(10,'Trần Thị E','trane@example.com','123456783','trane','123456',_binary '','giangvien',NULL),(11,'Nguyễn Thị F','nguyenf@example.com','123456784','nguyenf','123456',_binary '','giangvien',NULL),(12,'Hoàng Văn G','hoangg@example.com','123456785','hoangg','123456',_binary '','giangvien',NULL);
/*!40000 ALTER TABLE `nguoidung` ENABLE KEYS */;
UNLOCK TABLES;

INSERT INTO `scoredb`.`nguoidung` (`id`, `ten`, `email`, `sdt`, `username`, `password`, `active`, `role`, `avatar`) 
VALUES ('13', 'Tô Văn H', 'toh@uni.edu.vn', '123456786', 'toh', '123456', '1', 'sinhvien', 'https://res.cloudinary.com/dbqaequqv/image/upload/v1718265744/student_ninfvs.png');
--
...
-- Dump completed on 2024-06-18 11:44:58
